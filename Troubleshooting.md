...
## Remote controller stick works but buttons don't works
...
Search for logs starting with `|E|`, If you found one, this is an error and it might give you a hint about the issue.
